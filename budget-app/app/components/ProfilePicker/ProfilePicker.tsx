      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 md:gap-6">
        {users.map((user, index) => (
          <button
            ...
            className="group flex flex-col items-center gap-3 p-5 rounded-2xl border border-border bg-card/80 backdrop-blur-sm hover:border-accent hover:shadow-lg hover:shadow-accent/10 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 focus:ring-offset-background transition-all duration-300 disabled:opacity-60 disabled:cursor-not-allowed animate-fade-in-up opacity-0"
            style={{
  ...
  return (
    <>
      <div className="text-center mb-8 animate-fade-in opacity-0" style={{ animationFillMode: 'forwards' }}>
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-card/80 border border-border mb-6">
          <span className="text-lg font-bold text-foreground">HeHa</span>
          <span className="text-lg font-bold text-accent">Budgets</span>
        </div>
        <p className="text-xs text-muted-foreground uppercase tracking-widest">Control your cash, conquer your goals</p>
      </div>
      <ProfileGrid
        users={users}
