        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="flex-1">
            ...
            <input
              ...
              className={`w-full px-4 py-2 border text-background ${nameError ? "border-red-500" : "border-gray-300"} rounded-md focus:outline-none focus:ring-2 focus:ring-blue-400`}
              />
          </div>
        </div>
